...
const TIMER_OPTIONS = [
  ...
  { minutes: null, label: 'Turn Off Timer' },
];
      ...
      >
        <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold font-mono text-white">Sleep Timer</h3>
              <p className="text-[11px] text-neutral-400 font-mono">Gradual volume fade-out</p>
            </div>
          </div>
          <button
            onClick={onClose}
